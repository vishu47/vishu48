...
import TableWidget0 from 'sr/partials/widgets/widgets-components/tables/TableWidgets0'
import ViewWidget1 from 'sr/partials/widgets/widgets-components/view/ViewWidget1'

// type Props = {}

export default function UploadListTemplate() {
  // url
  ...
  const ExtractDocumnets = () => {
    setShow(true)
    setTimeout(() => {
      return navigate('/engine/extracted-output')
    }, 2000)
  }
  // useeffects
